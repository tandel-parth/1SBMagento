...
class Ccc_Productseller_Adminhtml_ProductsellerController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _isAllowed()
    {
        ...
        switch ($action) {
            case 'new':
                $aclResource = 'ccc_productseller/grid/actions/new';
                break;
            case 'edit':
                $aclResource = 'ccc_productseller/grid/actions/edit';
                break;
            case 'save':
                $aclResource = 'ccc_productseller/grid/actions/save';
                break;
            case 'delete':
                $aclResource = 'ccc_productseller/grid/actions/delete';
                break;
            default:
                $aclResource = 'ccc_productseller/grid/actions/index';
                break;
        }

...
class Ccc_Repricer_Adminhtml_MatchingController extends Mage_Adminhtml_Controller_Action
{
    ...
    //     $content = $this->getLayout()->createBlock('repricer/adminhtml_matching_grid')
    //         ->getCsv();
    ...
    public function exportCsvAction()
    {
        ...
        $fileName = $folderPath . '\data_upload' . time() . '.csv';
        $content = $this->getLayout()->createBlock('ccc_repricer/adminhtml_matching_grid')->getCsv();
